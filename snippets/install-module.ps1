...
Install-Module -Name VMware.PowerCLI -RequiredVersion 13.1.0 -Repository PSGallery
Install-Module -Name PowerVCF -RequiredVersion 2.4.0 -Repository PSGallery
